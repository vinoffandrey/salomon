                ...
                (function (e, i) {
                  t &&
                    window.addEventListener("online", function () {
                      !(function (e, t) {
                        var i;
                        ((i = ge(e)), he(i).filter(me)).forEach(function (t) {
  ...
  (() => {
    ...
    class de {
      constructor() {
        ...
        (o.__swiper__ = !0),
          (o.support = B()),
          (o.device = G({ userAgent: t.userAgent })),
          (o.browser = F()),
          (o.eventsListeners = {}),
    ...
    function ge(e) {
      ...
      function c() {
        ...
        if (
          ("fraction" === i.type &&
            (o.find(he(i.currentClass)).text(i.formatFractionCurrent(c + 1)),
            o.find(he(i.totalClass)).text(i.formatFractionTotal(u))),
          "progressbar" === i.type)
        ) {
          let e;
      ...
      function u() {
        ...
        if ("bullets" === e.type) {
          ...
          s.html(o), (t.pagination.bullets = s.find(he(e.bulletClass)));
        }
        "fraction" === e.type &&
          ((o = e.renderFraction
    ...
    window.addEventListener("load", function (e) {
      fe(),
        ...
        document.querySelector(".product__left-body") &&
          new ce(".product__left", {
            modules: [pe, ge, me],
            effect: "fade",
        ...
        document.querySelector(".product__resemble-body") &&
          new ce(".product__resemble-slider", {
            modules: [pe, ge, me],
            effect: "fade",
            observer: !0,
            observeParents: !0,
            ...
            breakpoints: {
              ...
              480: { slidesPerView: 2, spaceBetween: 20 },
              800: { slidesPerView: 3, spaceBetween: 20, autoHeight: !0 },
              1268: { slidesPerView: 4, spaceBetween: 30 },
            },
            on: {},
          });
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                S = Ze(o, x || "", g, this.settings.strings.playVideo, h);
                n.prepend(S);
              } else if (h) {
            ...
            v && !Ve(document.body).hasClass("lg-from-hash") && (E = v),
              ...
              (this.isFirstSlideWithZoomAnimation() &&
                ...
                this.onLgObjectLoad(n, e, v, E, f, !(!h || !h.html5 || o)),
              (this.zoomFromOrigin && this.currentImageSize) ||
        ...
        return (
          ...
          (e.prototype.getPossibleSwipeDragCords = function (e, t) {
            var i = t || this.scale || 1,
              ...
              p = { minY: l, maxY: d, minX: c, maxX: u };
            return (
              90 === Math.abs(e) &&
                (p = { minY: c, maxY: u, minX: l, maxX: d }),
              p
            );
          }),
      ...
      Lt = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = bt(bt({}, It), this.core.settings)),
            this
          );
        }
        return (
    ...
    if (
      (document.addEventListener("click", function (e) {
        let t = e.target,
          i = t.parentElement,
          s = document.querySelectorAll(".menu__item._ok");
        t.classList.contains("_icon-arrow-down") && i.classList.toggle("_ok");
        s.length > 1 && _t(s, "_ok");
        !t.closest(".menu__item") && s.length > 0 && _t(s, "_ok");
        ...
        if (
          ...
          (location.hash = ""),
            window.addEventListener(
              ...
              function () {
                e = e.split("#");
                const t = document.querySelector(`a[href*="#${e[0]}"]`);
                t &&
                  "#" !== t.href &&
                  setTimeout(function () {
                    t.click();
